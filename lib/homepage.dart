...
class _MyHomePageState extends State<MyHomePage>
  ...
  */
  ...
  void initState() {
    ...
    /*
    _timer = Timer.periodic(const Duration(milliseconds: 513), (timer) {
      setState(() {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: const Opacity(
              opacity: 0.021,
              child: Image(
                image: AssetImage('assets/static1.png'),
                fit: BoxFit.cover,
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                /*Icon(
                            Icons.email,
                            size: 28.0, // You can adjust the size as needed
                            color: const Color(0xffFFFFFF).withOpacity(
                                0.8), // You can adjust the color as needed
                          ),
                          ...
                          */
                                Expanded(
                                  child: TextFieldWidget(
                                    ...
                                    onChanged: (email) {
                                      ...
                                      //_user = _user!.copy(name: name);
                                      //_user = _user!.copy(
                                      //imagePath:
                                      //'assets/profileBeans/profileBean${((_user!.name.length % 12) + 1).toString()}.png');
                                    },
                                  ),
                                ),
                          ...
                          SizedBox(
                            ...
                            Align(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(
                                    left: 35.0, top: 5.0, bottom: 15.0),
                                child: Text(
                                  "© 20xx designed by Jadujam, Clouds in Seoul & coded by Wuzy"
                                      .replaceAll("20xx",
