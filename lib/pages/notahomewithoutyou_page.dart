...
class NotAHomeWithoutYouPage extends StatefulWidget {
  const NotAHomeWithoutYouPage({super.key, required this.title});

  final String title;

  @override
  State<NotAHomeWithoutYouPage> createState() => _NotAHomeWithoutYouPageState();
}

class _NotAHomeWithoutYouPageState extends State<NotAHomeWithoutYouPage>
  ...
  Future<void> _loadStrings() async {
    final lyrics = await rootBundle
        .loadString('assets/content/notahomewithoutyou_lyrics.txt');
    setState(() {
      songLyrics = lyrics;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Title(
        title: "Wuzy - not a home without you",
        color: AppColors.notahomewithoutyou_background,
        child: Scaffold(
          backgroundColor: AppColors.notahomewithoutyou_background,
          body: SafeArea(
            child: Stack(
              children: <Widget>[
                Column(
                          ...
                          children: [
                            ...
                            MouseRegion(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  Uri _url = Uri.parse(
                                      'https://open.spotify.com/track/6VfbuERy6qCyWbmWyxeDxV?si=fd4f2c4955e74c4b');
                            ...
                            MouseRegion(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  // TO UPDATE AFTER SONG RELEASE
                                  Uri _url = Uri.parse(
                                      'https://music.apple.com/us/album/not-a-home-without-you/1792955748?i=1792955989');
                                  if (!(await launchUrl(_url))) {
                                    throw 'Could not launch $_url';
                                  }
                                },
                            ...
                            MouseRegion(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  // TO UPDATE AFTER SONG RELEASE
                                  Uri _url = Uri.parse(
                                      'https://music.youtube.com/watch?v=oKGt4XzrNOI&si=CrOs3BHVc6VHDzcY');
                                  if (!(await launchUrl(_url))) {
                                    throw 'Could not launch $_url';
                                  }
                                },
                            ...
                            MouseRegion(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  // TO UPDATE AFTER SONG RELEASE
                                  Uri _url = Uri.parse(
                                      'https://www.youtube.com/watch?v=3fMHULvThmU');
                                  if (!(await launchUrl(_url))) {
                                    throw 'Could not launch $_url';
                                  }
                                },
