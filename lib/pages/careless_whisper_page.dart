                          ...
                          children: [
                            ...
                            MouseRegion(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  Uri _url = Uri.parse(
                                      'https://open.spotify.com/track/7kBewNawwQ4csS3sgW1HHm?si=bc111930fdf243a3');
                            ...
                            MouseRegion(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  Uri _url = Uri.parse(
                                      'https://music.youtube.com/watch?v=HKotlhifPuI&si=96QdENr12BCfYNju');
                                  if (!(await launchUrl(_url))) {
                                    throw 'Could not launch $_url';
                                  }
                                },
                            ...
                            MouseRegion(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  Uri _url = Uri.parse(
                                      'https://www.youtube.com/watch?v=I5l3lypU9jQ');
                                  if (!(await launchUrl(_url))) {
                                    throw 'Could not launch $_url';
                                  }
                                },
